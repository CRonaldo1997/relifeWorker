...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_label_welcome_prompts: 'Welcome page suggestions',
    settings_desc_welcome_prompts: 'Customize the quick-click prompts shown on the empty new-chat screen. Add, edit or remove suggestions.',
    settings_welcome_prompts_add: 'Add suggestion',
    settings_welcome_prompts_placeholder: 'Enter prompt text',
    settings_welcome_prompts_remove: 'Remove',
    settings_welcome_prompts_empty: 'No suggestions. Add one to show quick-click prompts on the welcome screen.',
    ...
    profile_avatar_delete: 'Remove avatar',
    profile_avatar_clear: 'Clear',
    profile_avatar_hint: 'PNG / JPG / WebP / GIF, max 5 MB. Used as the assistant avatar in chat.',
    profile_avatar_invalid_type: 'Unsupported image format. Use PNG, JPG, WebP, or GIF.',
    profile_avatar_too_large: 'Image is too large (max 5 MB).',
    profile_avatar_upload_failed: 'Avatar upload failed',
    profile_avatar_updated: 'Avatar updated',
    profile_avatar_deleted: 'Avatar removed',
    profile_avatar_delete_confirm_title: 'Remove avatar?',
    profile_avatar_delete_confirm_message: 'The assistant will fall back to the default avatar in chat.',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    kanban_assignee_profiles_label: 'Hermes 数字员工',
    kanban_assignee_other_label: '其他 (CLI 通道 / 已删除的数字员工)',
    kanban_assignee_unassigned: '— 未分配 (不会自动运行) —',
    kanban_ready_needs_assignee: '您选择了「未分配」+「Ready」。调度器将跳过此任务。再次提交以确认,或选择一个数字员工。',
    ...
    kanban_dispatch_skipped_nonspawnable: '跳过 (未知数字员工)',
    ...
    kanban_add_comment: '添加评论',
      ...
      kanban_lanes_by_profile: '按数字员工分列',
    ...
    sign_out: '退出登录',
    settings_label_welcome_prompts: '欢迎页问题',
    settings_desc_welcome_prompts: '自定义新对话欢迎页显示的快捷问题。可以添加、编辑或删除。',
    settings_welcome_prompts_add: '添加问题',
    settings_welcome_prompts_placeholder: '输入问题文本',
    settings_welcome_prompts_remove: '删除',
    settings_welcome_prompts_empty: '暂无问题。添加一个以在欢迎页显示快捷问题。',
    // Providers panel (English fallback — native translations welcome in follow-up PRs)
    providers_tab_title: '模型设置',
    providers_section_title: '模型设置',
    ...
    profile_name_placeholder: '数字员工名称（小写字母、a-z、0-9、连字符）',
    profile_clone_label: '复制当前数字员工的配置',
    profile_model_label: '模型 / 提供商',
    profile_model_hint: '为这个新数字员工选择已配置的提供商和模型。',
    profile_model_use_default: '使用当前数字员工默认值',
    ...
    profile_avatar_delete: '删除头像',
    profile_avatar_clear: '清除',
    profile_avatar_hint: '支持 PNG / JPG / WebP / GIF，最大 5 MB。作为聊天中助手的头像显示。',
    profile_avatar_invalid_type: '不支持的图片格式。请使用 PNG、JPG、WebP 或 GIF。',
    profile_avatar_too_large: '图片过大（最大 5 MB）。',
    profile_avatar_upload_failed: '头像上传失败',
    profile_avatar_updated: '头像已更新',
    profile_avatar_deleted: '头像已删除',
    profile_avatar_delete_confirm_title: '删除头像？',
    profile_avatar_delete_confirm_message: '助手在对话中将回退为默认头像。',
    ...
    profiles_empty_sub: '从侧边栏中选择一个数字员工以查看和编辑其设置，或创建一个新数字员工。',
    // skill form
    skill_name: '名称',
    skill_category: '分类',
    ...
    cron_profile_label: '数字员工',
    cron_profile_server_default: '服务器默认',
    cron_profile_server_default_hint: '运行时使用 WebUI 服务器默认数字员工。没有数字员工的现有作业会保留此旧行为。',
    ...
    settings_dropdown_providers: '模型设置',
